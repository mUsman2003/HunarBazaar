...
public class buyerGigCategoryDisplayController {
	        ...
	        try {
	            ...
	            chatButton.setOnAction(e -> {
	                try {
	                    ...
	                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/application/buyergigviewscene.fxml"));
	                    Parent scene2Root = loader.load();
	                    buyergigviewscenecontroller controller = loader.getController();
