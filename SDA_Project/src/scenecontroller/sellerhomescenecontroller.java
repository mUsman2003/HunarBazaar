...
public class sellerhomescenecontroller {
    ...
    @FXML
    private Button sellerdashboard;
    ...
    void GotoCategoryApplianceTechnician(ActionEvent event) {   	
    	...
    	try {
            Parent scene2Root = FXMLLoader.load(getClass().getResource("/application/sellergigbuy.fxml"));
